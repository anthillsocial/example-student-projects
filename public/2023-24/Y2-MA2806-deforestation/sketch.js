...
function setup() {
    ...
    infoHeader = createP(); // !!!!! if anyone wants to add interactive text for the graph, 
    //just make sure to create new column in .csv file then un-comment line 91, put text in quotes in bracket !!!!! 
